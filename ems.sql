...
(3, 'Chinmaya Prasad', 'cpbehera03@gmail.com', '$2y$10$ttCgC9DOCMazzlc8V.zM2ePRAGNv.IsnT0/0jIBZ78gOr2gjvqjYS', 'instructor'),
(4, 'Chinmaya Prasad Behera', 'chprasad@gmail.com', '$2y$10$zSpgm2VV8AxwdXIuC6gMD.nuLPpuYWudbbmo5NYOCFlDjWSp6TfvW', 'student');
...
ALTER TABLE `enrollments`
  ...
  ADD CONSTRAINT `enrollments_ibfk_3` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`id`);

--
-- Constraints for table `instructor_earnings`
--
ALTER TABLE `instructor_earnings`
  ADD CONSTRAINT `instructor_earnings_ibfk_1` FOREIGN KEY (`instructor_id`) REFERENCES `users` (`id`),
...
--
ALTER TABLE `lectures`
  ADD CONSTRAINT `lectures_ibfk_1` FOREIGN KEY (`section_id`) REFERENCES `course_sections` (`id`);
...
--
ALTER TABLE `quizzes`
  ADD CONSTRAINT `quizzes_ibfk_1` FOREIGN KEY (`lecture_id`) REFERENCES `lectures` (`id`);
